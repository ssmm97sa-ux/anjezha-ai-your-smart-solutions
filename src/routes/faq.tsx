...
const faqs = [
  {
    ...
    a: "أغلب الطلبات تُسلم خلال ٦ إلى ٢٤ ساعة حسب نوع الخدمة وحجم العمل. الطلبات المستعجلة يمكن تسليمها في نفس اليوم عند التنسيق معنا.",
  },
  {
    q: "كيف يتم الدفع؟",
    a: "الأسعار بالدرهم الإماراتي (AED)، والدفع يتم إلكترونياً عبر بوابة Ziina الآمنة مباشرة بعد إرسال تفاصيل طلبك. طرق أخرى مثل PayPal وApple Pay وGoogle Pay قيد التفعيل.",
  },
  {
